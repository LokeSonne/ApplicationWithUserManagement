        ...
        public virtual object BindModel(ControllerContext controllerContext, ModelBindingContext bindingContext)
        {
            ...
            if (!performedFallback)
            {
                ...
                var provider = (bindingContext.ValueProvider as IUnvalidatedValueProvider)
                    ?? new UnvalidatedValueProviderWrapper(bindingContext.ValueProvider);
                ValueProviderResult valueProviderResult = provider.GetValue(bindingContext.ModelName, skipValidation: !performRequestValidation);
